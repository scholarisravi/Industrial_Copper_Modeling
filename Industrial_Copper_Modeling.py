...
def streamlit_config():
    ...
    # page configuration
    st.set_page_config(page_title='Industrial Copper Trends Analysis')
    ...
    # title and position with blinking effect
    st.markdown(f'<h1 class="blinking" style="text-align: center;">Industrial Copper Modeling</h1>', unsafe_allow_html=True)

     # Scrolling text using HTML marquee tag
    scrolling_text = """
    <div style="overflow: hidden;">
        <marquee behavior="scroll" direction="left" style="font-size: 24px; color: orange;">
            Welcome to Industrial Copper Modeling - Your Source for Copper Industry Insights!
        </marquee>
    </div>
    """
...
class prediction:
    ...
    def regression():
        ...
        if button:
            ...
            with open(r'C:\\Users\\Ravishankar\\Downloads\\Industrial-Copper-Modeling-main\\Industrial-Copper-Modeling-main\\regression_model.pkl', 'rb') as f:
                model = pickle.load(f)
    ...
    def classification():
        ...
        if button:
            ...
            with open(r'C:\\Users\\Ravishankar\\Downloads\\Industrial-Copper-Modeling-main\\Industrial-Copper-Modeling-main\\classification_model.pkl', 'rb') as f:
                model = pickle.load(f)
            ...
            return status
streamlit_config()
tab1, tab2 = st.tabs(['Selling Price Prediction', 'Status of Prediction'])
